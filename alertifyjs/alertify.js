                            ...
                            $('INPUT[type="tel"]').keyup(function (e) {
                                ...
                                if(!input_val.match(letters)){
                                    ...
                                    if((e.keyCode >= 48 && e.keyCode <= 57) || e.keyCode == 8){
                                        ...
                                        if ($text.val().length === 3 && e.keyCode != 8) {
                                            $text.val($text.val() + '-');
                                        }
                                        if ($text.val().length === 7 && e.keyCode != 8) {
                                            $text.val($text.val() + '-');
                                        }
                                        if ($text.val().length === 13 && e.keyCode != 8) {
                                            //console.log($text.val()+e.key);
    
                                            let f = $text.val();
                                            let f_val = f.replace(/[^0-9.]/g, ''); //(/\D[^\.]/g, "");
                                            //console.log(f_val);
                                            let new_val = f_val.slice(0,3)+"-"+f_val.slice(3,7)+"-"+f_val.slice(7);
                                            //console.log(new_val);
                                            $text.val(new_val);
                                        ...
                                        if ($text.val().length === 12) {
                                            ...
                                            let f_val = f.replace(/[^0-9.]/g, ''); //(/\D[^\.]/g, "");
                                            //console.log(f_val);
                                            let new_val = f_val.slice(0,3)+"-"+f_val.slice(3,6)+"-"+f_val.slice(6);
                                            //console.log(new_val);
                                            $text.val(new_val);
                                        ...
                                        if ($text.val().length === 14) {
                                            ...
                                            let f_val = $text.val();
                                            let new_val = f_val.slice(0,-1);
                                            //console.log(new_val);
                                            $text.val(new_val);
                                            //console.log('last digit deleted');

                                            alertify.error('Possible number of digits exceeded.');
