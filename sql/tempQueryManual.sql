...
(302, 'Jimin Lee', 3, FROM_UNIXTIME(UNIX_TIMESTAMP() - 900), FROM_UNIXTIME(UNIX_TIMESTAMP() - 780), 'Arrived', '2', '010-2222-2222', 'sub_bbb', 100, 'DL_Sunway_Geo', 'QR', FROM_UNIXTIME(UNIX_TIMESTAMP() - 900), '', '', ''),
